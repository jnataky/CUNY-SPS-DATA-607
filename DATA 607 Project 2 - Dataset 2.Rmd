...
The original data set was downloaded from Kaggle and is [available here.](https://www.kaggle.com/spscientist/students-performance-in-exams)
...
###LEFT OFF HERE - explain methodology then analyze results then conclude :)
Then, we'll plot average student scores based on parent education level for Math, Reading, and Writing.
